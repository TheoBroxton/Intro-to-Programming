# -*- coding: utf-8 -*-
"""
PHYS20161 Week 3 Quiz - Cubic Bravais Lattices B
...
def length_input():
    """
    Gets lattice edge length from user in Angstrom. Only accepts numerical
    answers greater than 0.
    ...
    while True:
        ...
        if not lattice_edge_string.isalpha():
            ...
            return float(lattice_edge_string)
